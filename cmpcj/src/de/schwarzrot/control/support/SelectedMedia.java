 ...
 * ======================== legal notice ======================
 * 
 * File: SelectedMedia.java Created: 13. June 2012, 04:57 Author: <a
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        if (e.getSource() instanceof DefaultEventSelectionModel) {
            ...
            if (sm.isSelectionEmpty())
                return;
            int i = sm.getLeadSelectionIndex();

            if (i > 0)
                pcs.firePropertyChange(MEDIA_PROPERTY, this.media, this.media = mediaList.get(i));
        }
    }
